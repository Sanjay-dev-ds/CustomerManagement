										...
										<div class="card">
											<div class="card-body">
                                                ...
                                                <form  method="get" action=""  >
                                                  <label class="input1">Customer Username :</label>
                                                    <input  name="Uname" type="text">    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                  <button type="submit" class="btn btn-blue"><i class="bi bi-search"></i> <span>View Details</span></button>
                                              </form>
...
String query;
if(id!=null){
 query = "SELECT Email,Firstname,Username,Lastname,Address,province,city,postalcode,Age,Gender,Phone FROM customers where Username='"+id+"'";
    
}
else{
 query = "SELECT Email,Firstname,Username,Lastname,Address,province,city,postalcode,Age,Gender,Phone FROM customers where Username='"+id2+"'";
