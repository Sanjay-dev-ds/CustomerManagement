...
<form name="Register2Validate" onsubmit="return(RegisterValidate2())"  enctype = "multipart/form-data" action="${pageContext.request.contextPath}/AddCustomerServlet2"  class="form" method="post">
...
<input required id="in" onchange="PreviewImage(this)" style="margin-left: 250px; margin-bottom: 50px;" name="profile" accept="image/*" type="file" >  

<br>
<label style="margin-left: 50px;" for="Uname">User name :</label>
<input id="Uname" name="Uname" required type="text">
