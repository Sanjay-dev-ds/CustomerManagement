...
<div class="container fluid container3">
    ...
    <form class="form" method="POST"  action="${pageContext.request.contextPath}/AddFeedbackServlet"  >
...
<div class="container">
    ...
    <label style="width: 500px;" for="Feedback">Please leave your feedback below :</label><br>
